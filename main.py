...
class LaneFinder(object):
    ...
    def __init__(self, save_original_images, camera_calibration_file="./output_images/camera_calibration_pickle.p"):
    ...
    def process_image(self, image):
        ...
        compose_images(final_image, image, 2, 2, 1)

        if self.save_original_images:
            save_image(image, "./video_images/{}.jpg".format(self.process_counter))

        undistored_image = cv2.undistort(image, self.camera_matrix, self.distortion, None, self.camera_matrix)
...
if __name__ == "__main__":
    lane_finder = LaneFinder(save_original_images=False)
